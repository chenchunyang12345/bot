...
export default {
    ...
    reducers: {
        ...
        setNameReg(state, { payload: name_reg }) {
            return { ...state, name_reg };
        },
        // 设置真实客户信息
